...
import LogoSrc from '../../../assets/brand/Evolution-Logo-Black.svg';
...
export function EditorialFooter() {
		...
		<footer className="bg-white relative">
			...
			<div className="fixed left-4 top-1/2 transform -translate-y-1/2 z-50">
				<div className="flex flex-col items-center gap-4">
					{/* Evolution Logo (highlighted) */}
					<a href="/" aria-label="Evolution Stables" className="block">
						<div className="p-1 rounded-full bg-white shadow-sm">
							<img src={LogoSrc} alt="Evolution" className="h-3.5 w-3.5 md:h-4 md:w-4" />
						</div>
					</a>

					{/* Social icons (kept visually consistent) */}
					<a
	...
	{/* Keep footer box to preserve layout spacing */}
